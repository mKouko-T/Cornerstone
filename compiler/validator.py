...
class Validator:
    ...
    def _fetch_remote_compiler(self, ir: CanonicalIR):
        ...
        if self.mode == "pinned":
            ...
            url = f"https://raw.githubusercontent.com/mKouko-T/Foundation_Zero/{sha_to_fetch}/BOOT_CONTEXT.md"
        ...
        try:
            ...
            raise RuntimeError(f"COMPILER FATAL: Could not fetch remote compiler context. {e}")
    ...
    def _resolve_dependencies(self, ir: CanonicalIR):
        ...
        ir.provenance.dependency_graph = [
            "CRBP.md",
            "Foundation_Zero/BOOT_CONTEXT.md (remote)",
            "docs/Runtime_Contract.md",
            "BOOTSTRAP.md",
            "docs/Canonical_Model.md",
            "docs/Genesis_Methodology.md",
