...
class Emitter:
    ...
    def emit(self, ir: CanonicalIR):
        ...
        lines.append(f"**BOOT_ID:** `{ir.provenance.boot_id}`")
        ...
        lines.append("")
        lines.append(ir.knowledge_state.runtime_rules)
        lines.append("")
        ...
        lines.append("")
        lines.append(ir.knowledge_state.canonical_model)
        lines.append("")
        ...
        lines.append("")
        lines.append(ir.knowledge_state.methodology)
        lines.append("")
        ...
        lines.append("2. Verify the Cryptographic Certification block in `BOOT_MANIFEST.json` is valid.")
